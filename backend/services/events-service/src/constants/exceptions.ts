...
export const CAN_NOT_FIND_RECOMMENDED_EVENTS =
  'Can not find recommended events! Try to add some interests!';
export const INVITE_IS_NOT_FOUND = 'Invite is not found';
export const YOU_ARE_NOT_THE_RECEIVER_OF_THIS_INVITE =
  'You are not the receiver of this invite!';
export const INSUFFICIENT_AMOUNT_OF_MONEY_TO_BUY_TICKET =
  'Insufficient amount of money to buy a ticket!';
